...
\subsection{Instalando y configurando el DHCP de la ISC} % (fold)
\label{sub:Instalando y configurando el DHCP de la ISC}

% subsection Instalando y configurando el DHCP de la ISC (end)

\begin{frame}[allowframebreaks,fragile]{Instalando el paquete en Debian}
